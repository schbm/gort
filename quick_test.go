...
func TestQuick(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "1000000 items",
			args: args{
				arr: CreateIntSlice(1000000),
			},
		},
		{
			name: "10000000 items",
			args: args{
				arr: CreateIntSlice(10000000),
			},
		},
		{
			name: "50000000 items",
			args: args{
				arr: CreateIntSlice(50000000),
			},
		},
		{
			name: "100000000 items",
			args: args{
				arr: CreateIntSlice(100000000),
			},
		},
	}
